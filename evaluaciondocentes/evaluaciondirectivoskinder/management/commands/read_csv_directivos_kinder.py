...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        with open(base_dir_path + '/load_init/evaluados-equipo-de-direccion-kinder.csv') as csvfile_in, open(base_dir_path + '/load_init/evaluados-equipo-de-direccion-kinder.csv') as csvfile_evaluadores:
