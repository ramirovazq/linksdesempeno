...
class ProfesorAdmin(admin.ModelAdmin):
    ...
    list_filter = ['response_boolean_profesor_autoevaluacion', 'materia', 'autoevaluacion', 'survey_closed']


class EquipoDirectivoAdmin(admin.ModelAdmin):
    list_display = ['id', 'nombre', 'profesor', 'id_survey', 'response_boolean_survey', 'response_survey', 'survey_closed']
